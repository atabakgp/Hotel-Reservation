<template>
  <!-- Card component from MadeWithVue.js -->
  <div class="wrapper card d-flex justify-center px-0">
    <div class="card-form">
      <div class="card-list">
            ...
            <div class="card-item__wrapper">
              ...
              <label for="cardNumber" class="card-item__number" ref="cardNumber">
                ...
                <template v-else>
                  <span v-for="(n, $index) in otherCardMask" :key="$index">
                    <transition name="slide-fade-up">
                      <div class="card-item__numberItem" v-if="$index > 4 && $index < 9 && cardNumber.length > $index && n.trim() !== ''">
                        *
                      </div>
                      <div class="card-item__numberItem" :class="{ '-active': n.trim() === '' }" :key="$index" v-else-if="cardNumber.length > $index">
                        {{ cardNumber[$index] }}
              ...
              <div class="card-item__content">
                <label for="cardName" class="card-item__info" ref="cardName">
                  <div class="card-item__holder">Ad Soyad</div>
                  <transition name="slide-fade-up">
                    ...
                    <div class="card-item__name" v-else key="2">XXX XXXX</div>
                  </transition>
                </label>
      ...
      <div class="card-form__inner">
        <div class="card-input">
          ...
          <input type="text" id="cardNumber" maxlength="13" class="card-input__input" v-mask="generateCardNumberMask" v-model="cardNumber" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardNumber" autocomplete="on" />
        </div>
        <div class="card-input">
          <label for="cardName" class="card-input__label">Ad ve Soyad</label>
          <input type="text" id="cardName" class="card-input__input" v-model="cardName" v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName" autocomplete="off" />
        </div>
        <div class="card-form__row">
          <div class="card-form__col">
            <div class="card-form__group">
              <label for="cardMonth" class="card-input__label">Son Kullanım Tarihi</label>
...
export default {
  ...
  mounted() {
    ...
    this.cardName = this.reservationDetails.card_name
    this.cardNumber = this.reservationDetails.card_number
    this.cardMonth = this.reservationDetails.card_date_month
    this.cardYear = this.reservationDetails.card_date_year
    this.cardCvv = this.reservationDetails.card_cvv
  },
